...
| # | Description |
|---|---|
| [BUG-71](https://github.com/kristianwiklund/signalk-weather-routing/issues/212) | Unit preferences not applied in the frontend. When the SignalK active unit preference is set to metric or imperial/US, all velocity units in input fields and labels remain as knots, and the safety margin distance is still displayed as NM. Expected: all frontend unit labels update to match the selected unit preset. |
