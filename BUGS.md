...
| # | Description |
|---|---|
| [BUG-41](https://github.com/kristianwiklund/signalk-weather-routing/issues/105) | Åland→Gothenburg route (test 12) goes south of Fyn and gets stuck near Kiel instead of continuing to Gothenburg. |
| [BUG-40](https://github.com/kristianwiklund/signalk-weather-routing/issues/104) | Åland→Gothenburg route (test 12) idles up and down the Estonian coastline instead of making direct progress toward Gothenburg after leaving Åland. |
