...
| # | Requirement | Status |
|---|---|---|
| [REQ-122](https://github.com/kristianwiklund/signalk-weather-routing/issues/287) | **Original:** «add a feature: offline leaflet.»<br>**Interpretation:** Replace the CDN-based Leaflet imports (unpkg.com) with locally-bundled copies so the GUI works without internet access. | open |
