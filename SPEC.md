...
| # | Requirement | Status |
|---|---|---|
| [REQ-113](https://github.com/kristianwiklund/signalk-weather-routing/issues/250) | **Original:** «we have no performance improvements on the bl.»<br>**Interpretation:** Add one or more requirements to the backlog addressing isochrone routing performance, targeting faster execution on low-end hardware (Raspberry Pi 3, ARM64). The specific optimisation approach is not yet decided. | open |
