...
| [REQ-98](https://github.com/kristianwiklund/signalk-weather-routing/issues/179) | The routing algorithm treats SignalK regions (e.g. drawn in freeboard-sk and stored in `resources/regions`) as avoidance zones — the route will not pass through them. The user interface shows the defined regions in its map, the user can click them to mark them as areas to avoid. | open |
