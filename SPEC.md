...
| # | Requirement | Status |
|---|---|---|
| [~~REQ-91~~](https://github.com/kristianwiklund/signalk-weather-routing/issues/168) | ~~Ocean current GRIB support (RTOFS/CMEMS/BSH).~~ — **done** (auto-detect current GRIBs by UOGRD/VOGRD bands; bilinear interpolation with fill-value zeroing; current drift applied to isochrone frontier; sidebar with checkbox/bbox/staleness/tidal disclaimer; Currents overlay; unified scrubber time axis; confirmed 2026-06-14) | done |
