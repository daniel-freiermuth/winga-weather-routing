...
| [REQ-81](https://github.com/kristianwiklund/signalk-weather-routing/issues/151) | Motor fallback triggers whenever computed boat speed is below the `minBoatSpeed` threshold, not only when the polar returns exactly zero. | open |
