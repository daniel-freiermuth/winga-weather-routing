...
| # | Requirement | Status |
|---|---|---|
| [~~REQ-109~~](https://github.com/kristianwiklund/signalk-weather-routing/issues/228) | ~~Investigate GSHHG `f`-tier feasibility for land avoidance mask.~~ — **done** (`f` build completed: 179,837 polygons, 86.5 MB edge index + 167.3 MB dilated index; routing performance unaffected; package size too large to bundle — outcome: distribute via optional npm package, tracked as REQ-113; confirmed 2026-06-13) | done |
