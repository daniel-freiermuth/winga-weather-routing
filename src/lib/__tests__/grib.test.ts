...
void test('sanitizeGribName: accepts plain GRIB basenames', () => {
...
void test('sanitizeGribName: rejects non-GRIB extensions', () => {
...
void test('sanitizeGribName: strips path components (no directory traversal)', () => {
...
void test('sanitizeGribName: rejects empty / dot / missing', () => {
